...
from optitrack_handler_new2 import OptitrackHandlerNew2
...
from tps_calib import TPScalibration
from emg_calibration.calib_app import openApp
from gopro_handler import GoProHandler
...
class RecorderNew():
    ...
    def tps_thread(self):
        ...
        # proc.communicate(self.folder_input+"\n"+self.subject_nb+"\n"+self.task_input+"\n"+"2")
    ...
    def copy_calibration_files(self):
        ...
        destination_dir = join('Recorder_2022', 'source', 'surgeon_recording', 'config')
